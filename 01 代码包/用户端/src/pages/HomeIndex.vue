<template>
  <div class="MallIndex">
    <FadeSwiper class="swiperBox" :width="clientWidth" height="420px">
      <img class="banner" slot="item1" src="../assets/images/banner1.jpg" />
      <img class="banner" slot="item2" src="../assets/images/banner2.jpg" />
      <img class="banner" slot="item3" src="../assets/images/banner3.jpg" />
    </FadeSwiper>
    <section class="newGoods section">
      ...
      <Slick
        ...
        :height="360" style="transform: translateX(55px);"
      >
        <ul
          class="goodsList"
          :style="{
      ...
      <div class="content">
        ...
        <ul class="right">
          <li v-for="item in goodsList.slice(0, 4)" :key="item.id">
            <img class="leftImg" :src="pictureGet(item.urls[0])" />
            <div class="rightBox">
              <p
    ...
    <section class="hotGoods section">
      ...
      <div class="content">
        <ul class="left">
          <GoodsItem
            :id="goodsList[0].id"
            :img="pictureGet(goodsList[0].urls[0])"
...
<script>
import { getTypesApi, getGoodsListApi, getAllGoodsApi } from "../api/index";
...
import { getClientSize, getScrollWidth } from "../utils/request";
...
export default {
    ...
    return {
      ...
      goodsList: [
        ...
        },
        {
          id: 5,
          typeId: "2",
          img: "https://tse1-mm.cn.bing.net/th/id/OIP-C.FhsFF0qE2XuZ5lcNb4ZfawHaHa?w=198&h=198&c=7&r=0&o=5&dpr=1.5&pid=1.7",
          name: "洗衣机",
          price: 4000,
        },
        {
  ...
  methods: {
    ...
    getAllGoodsList() {
      getAllGoodsApi().then(({ data }) => {
        if (data.code == 200) {
          this.goodsList = data.data;
          // for(var i=0;i<this.goodsList.length;i++)
          // {
          //   if(this.goodsList.urls==null){
